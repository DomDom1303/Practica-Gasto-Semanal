//Variables
const presuspuestoUsuario = prompt('Cual es tu presupuesto semanal?');
...
class Interfaz {
 ...
 imprimirMensaje(mensaje, tipo){
   ...
   agregaGastoListado(nombre, cantidad){
...
if(presuspuestoUsuario === null || presuspuestoUsuario === ''){
    window.location.reload();
} else {
    //Instanciar un presupuesto
    cantidadPresupuesto = new Presupuesto(presuspuestoUsuario);
...
formulario.addEventListener ('submit', function(e){
    ...
    if(nombreGasto === '' || cantidadGasto === ''){
        ...
        ui.agregaGastoListado(nombreGasto,cantidadGasto);
